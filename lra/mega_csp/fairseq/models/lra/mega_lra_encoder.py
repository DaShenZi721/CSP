...
class MegaLRAEncoder(nn.Module):
    ...
    def __init__(
        ...
        print('ATTENTION!!! Using Sliceformer padding!!!')
    ...
    def forward(
        ...
        # new_seq_len = int(2 * math.ceil(seq_len / 2))
        ...
        # aan tokens: torch.Size([8, 4001])
        # aan src_lengths: [4001, 4001, 4001, 4001, 4001, 4001, 4001, 4001]
        ...
        for i in range(self.num_layers):
            x, _ = self.layers[i](x, x_padding_mask=padding_mask, src_lengths=src_lengths)
            if not last_state_only:
                inner_states.append(x)
